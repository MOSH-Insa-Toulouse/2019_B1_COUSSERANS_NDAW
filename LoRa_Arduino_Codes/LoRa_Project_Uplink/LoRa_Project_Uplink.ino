...
void initialize_radio()
{
   ...
   */
  const char *devAddr = "26011A98";
  const char *nwkSKey = "16E2F2A8C9DBE3CE26EC580AB1E7F4DD";
  const char *appSKey = "7AD9C67B04805CC9C7C70D79CA1C610F";
...
void loop()
{
    ...
    myLora.tx("#Eg"); //four byte, blocking function
